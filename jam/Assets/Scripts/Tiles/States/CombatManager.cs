...
namespace DefaultNamespace
{
    public static class CombatManager
    {
        ...
        // 2 AC WIN
        // 3 B WIN
        public static int DoubleOneWaySingleAttack(List<IUnit> A, List<IUnit> B, List<IUnit> C) //B ATTACK FIRST
        {
            while (true)
            {
                int resultAB;
         ...
         */
        public static int Versus(List<IUnit> A, List<IUnit> B, bool Afirst)
        {
        ...
        private static int VersusLoop(List<IUnit> A, List<IUnit> B)
        {
            int result = 0;
            while (true)
            {
        ...
        public static int OneWayAttackLoop(List<IUnit> A, List<IUnit> B)
        {
        ...
        public static int SingleAttack(List<IUnit> A, List<IUnit> B)
        {
            ...
            AUnit.Attack(BUnit.UnitController.unit);
